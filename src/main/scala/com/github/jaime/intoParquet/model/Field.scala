...
import com.github.jaime.intoParquet.model.enumeration.{BooleanType, DecimalType, DoubleType, IntegerType, LongType, SQLType, ShortType, StringType, TimeStampType}
